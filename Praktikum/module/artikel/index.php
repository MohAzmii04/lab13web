    ...
    <div class="container">
        ...
        <form action="index.php" method="get">
            <div class="search">
                ...
                <input type="submit" name="submit" value="Cari" class="btn btn-primary" style="background-color: darkblue; color: #ffffff; padding: 6px 24px; font-weight: 700; border: 1px solid var(--white); border-radius: 6px; cursor: pointer;">
            </div>
        </form>
        </div>
        <div class="main">
